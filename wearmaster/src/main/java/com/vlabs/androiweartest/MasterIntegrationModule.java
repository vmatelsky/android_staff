...
public class MasterIntegrationModule {
    ...
    public static PublishSubject<List<OuterStation>> mSearchStationsObservable = PublishSubject.create();
    ...
    public InPort.SearchStationsPin<List<OuterStation>> mySearchStationsPin = new InPort.SearchStationsPin<>(mSearchStationsObservable, new OuterStation.StationsListConverter());
