...
public class OuterPlayerState {

    public static class Converter implements com.vlabs.Converter<OuterPlayerState, WearPlayerState> {

        @Override
        public WearPlayerState convert(final OuterPlayerState outerPlayerState) {
            return new WearPlayerState(outerPlayerState.getData());
        }
    }
    ...
    public OuterPlayerState(final DataMap dataMap) {
        mDataMap = dataMap;
    }

    public OuterPlayerState() {
